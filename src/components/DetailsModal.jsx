            ...
            <div className="relative z-10 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">Just a few more details</p>
                </div>
              </div>
              <motion.button
          ...
          <div className="relative z-10 p-8 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <motion.input
                    ...
                    className="w-full pl-12 pr-4 py-4 border-2 border-neutral-200 rounded-2xl focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-300 bg-white/80 backdrop-blur-sm"
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={onClose}
                className="flex-1 py-4 px-4 border-2 border-neutral-200 text-neutral-600 rounded-2xl font-semibold hover:bg-neutral-50 transition-all duration-300"
              >
                Cancel
              </motion.button>
              <motion.button
                ...
                className="flex-1 py-4 px-4 bg-gradient-to-r from-primary to-secondary text-white rounded-2xl font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 relative overflow-hidden"
              >
                <motion.div
