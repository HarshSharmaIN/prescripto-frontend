      ...
      <div className="relative flex flex-col lg:flex-row items-center px-6 md:px-12 lg:px-20 py-12 lg:py-20">
        ...
        >
          <motion.h1
            ...
            className="text-3xl md:text-5xl lg:text-6xl font-bold text-neutral-800 leading-tight"
          >
            <motion.span
              animate={{ 
                textShadow: [
        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              className="absolute top-6/8 -left-4 bg-white/95 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-white/50"
            >
