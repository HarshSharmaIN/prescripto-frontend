      ...
      <StreamTheme>
        <div className="relative min-h-screen flex flex-col">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            className="bg-black/30 backdrop-blur-md border-b border-white/10 p-3 sm:p-4 lg:p-6 z-10"
          >
            <div className="max-w-7xl mx-auto flex items-center justify-between">
              <div className="flex items-center gap-2 sm:gap-4">
                <motion.div
                  animate={{ scale: [1, 1.1, 1] }}
                  transition={{ duration: 2, repeat: Infinity }}
                  className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl sm:rounded-2xl flex items-center justify-center"
                >
                  <Video className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-white" />
                </motion.div>
                <div>
                  <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-white">Medical Consultation</h1>
              ...
              <div className="flex items-center gap-2 sm:gap-4 lg:gap-6">
                <motion.div
                  ...
                  transition={{ duration: 2, repeat: Infinity }}
                  className="flex items-center gap-1 sm:gap-2 bg-green-500/20 px-2 sm:px-3 lg:px-4 py-1 sm:py-2 rounded-lg sm:rounded-xl border border-green-500/30"
                >
                  <Signal className="w-3 h-3 sm:w-4 sm:h-4 text-green-400" />
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
                {participants.map((participant, index) => (
                  ...
                  >
                    <div className="bg-black/20 backdrop-blur-md rounded-2xl sm:rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                      <ParticipantView 
                      ...
                      <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        className="absolute bottom-2 sm:bottom-3 lg:bottom-4 left-2 sm:left-3 lg:left-4 right-2 sm:right-3 lg:right-4 bg-black/50 backdrop-blur-md rounded-xl sm:rounded-2xl p-2 sm:p-3 lg:p-4 border border-white/20"
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2 sm:gap-3">
                            <div className="w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center">
          ...
          <motion.div
            ...
            className="bg-black/30 backdrop-blur-md border-t border-white/10 p-3 sm:p-4 lg:p-6 z-10"
          >
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center justify-center">
                <div className="bg-black/40 backdrop-blur-md rounded-2xl sm:rounded-3xl p-2 sm:p-3 lg:p-4 border border-white/20">
                  <CallControls
