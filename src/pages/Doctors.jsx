                  ...
                  >
                    ...
                    <div className="p-6">
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1 min-w-0">
                          <h3 className="text-xl font-bold text-neutral-800 group-hover:text-primary transition-colors truncate">
                            {doctor.name}
                          </h3>
                          <p className="text-primary font-semibold truncate">{doctor.speciality}</p>
                        </div>
                      ...
                      <div className="space-y-2 mb-4">
                        <div className="flex items-center gap-2 text-sm text-neutral-600">
                          ...
                          <span className="truncate">{doctor.address.line1}</span>
                        </div>
                        <div className="flex items-center gap-2 text-sm text-neutral-600">
